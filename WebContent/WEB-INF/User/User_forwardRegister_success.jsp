...
$(document).ready(function(){
	  $("#registerbtn").click(function(){
			var flag = $("#username").val()=='' || $("#pwd").val()=='' || $("#realname").val()=='' ||$("#addr").val()=='' ||$("#phone").val()==''|| $("#validatecode").val()=='' ;
			if(flag){
				$("#alert_p").show();
			}else{
				$("#alert_p").hide();
...
<hr>
<div id="main">
<div class="alert alert-success" role="alert">您现在的位置：首页>>注册</div>

<form class="form-horizontal" role="form"  method="post" action="User_register">
  <div class="form-group">
    <label for="uname" class="col-sm-2 control-label">用户名</label>
    <div class="col-sm-4">
      <input type="text" class="form-control" id="username" placeholder="登录时的用户名" name="user.username">
    </div>
  </div>
  <div class="form-group">
    <label for="realname" class="col-sm-2 control-label">真实姓名</label>
    <div class="col-sm-4">
      <input type="text" class="form-control" id="realname" placeholder="有效证件姓名" name="user.realname">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <input type="text" class="form-control" id="addr" placeholder="地址" name="user.address">
    </div>
  </div>
  <div class="form-group">
    <label for="phone" class="col-sm-2 control-label">手机号</label>
    <div class="col-sm-4">
      <input type="text" class="form-control" id="phone" placeholder="联系方式" name="user.phone">
    </div>
  </div>
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-8">
      <button type="submit" class="btn btn-default" id="registerbtn">快速注册</button>
    </div>
  </div>
